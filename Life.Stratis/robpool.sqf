...
while {true} do {
	...
	["robpoolsafe1", robpoolsafe1] spawn A_stats_fnc_server_save;
	["robpoolsafe2", robpoolsafe2] spawn A_stats_fnc_server_save;
	["robpoolsafe3", robpoolsafe3] spawn A_stats_fnc_server_save;
