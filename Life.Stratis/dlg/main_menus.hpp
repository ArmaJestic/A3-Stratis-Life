class MainMenu{
    ...
    class button_graphics : RscButton {
        ...
        h = 0.04;
        text = "Graphics";
        action = "closedialog 0;[""GrafikEinstellungen""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_texts : RscButton {
        ...
        h = 0.04;
        text = "Say Texts";
        action = "closedialog 0;[""TextEinstellungen"", ""oeffnen""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_tutorial : RscButton {
        ...
        h = 0.04;
        text = "Tutorial";
        action = "closedialog 0;[""Tutorial""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_faq : RscButton {
        ...
        h = 0.04;
        text = "FAQ";
        action = "closedialog 0;[""FAQ""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_about : RscButton {
        ...
        h = 0.04;
        text = "About";
        action = "closedialog 0;[""About""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_iteminfo : RscButton {
        ...
        h = 0.04;
        text = "Item info";
        action = "closedialog 0;[""ItemList""] spawn A_settings_fnc_settings;";
    };
...
class SettingsDialog{
    ...
    class button_cancel : RscButton {
        ...
        h = 0.04;
        text = "Back";
        action = "closedialog 0;[""Einstellungen""] spawn A_settings_fnc_settings;";
    };
    ...
    class button_save : RscButton {
        ...
        h = 0.04;
        text = "Save";
        action = "[""TextEinstellungen"", ""speichern""] spawn A_settings_fnc_settings;";
    };
