#define loadingTitle_idc 101
#define loadingProgressReverse_idc 103
#define loadingProgress_idc 104
#define loadingProgressText_idc 105
#define customLoadingScreen_idc 55555
