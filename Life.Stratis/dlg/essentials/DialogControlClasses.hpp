...
// RscCheckboxes // actually more like "toggle buttons"
class RscToolbox  {
	idc = -1;
	type = CT_CHECKBOXES;
	style = ST_LEFT;
	...
	x = 0.1; y = 0.18;
	w = 0.15; h = Dlg_CONTROLHGT; // surrounding box + row gaps
...
class Dlg_CloseIcon: RscPicture1 {
	x = 0.00; y = 0.00;
	w = Dlg_ICONWIDTH; h = Dlg_CONTROLHGT;
