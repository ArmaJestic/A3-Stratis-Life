...
if (_art == "init") then {
	if (not(undefined(bombs_init_functions_defined))) exitWith {};
	bombs_init_functions_defined = true;
...
if (_art == "server") then {
	if (not(undefined(bombs_server_functions_defined))) exitWith {};
	bombs_server_functions_defined = true;
