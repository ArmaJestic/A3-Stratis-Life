...
while {true} do {
	...
	while {true} do {
		...
		if (_zielzahl != _startzahl and ((_spielerstart distance _start)+(_start distance _ziel)) < taximaxdistance and ((_spielerstart distance _start)+(_start distance _ziel)) > taximindistance) exitWith {null};
