...
RadioTrigger_1 setTriggerArea       [0, 0, 0, false];
RadioTrigger_1 setTriggerActivation ["ALPHA", "NOT PRESENT", true];
RadioTrigger_1 setTriggerStatements ["this", "[RadioTextMsg_1, RadioTextArt_1] call A_misc_fnc_SayDirectSpeach;", ""];
...
RadioTrigger_2 setTriggerStatements ["this", "[RadioTextMsg_2, RadioTextArt_2] call A_misc_fnc_SayDirectSpeach;", ""];
...
RadioTrigger_3 setTriggerStatements ["this", "[RadioTextMsg_3, RadioTextArt_3] call A_misc_fnc_SayDirectSpeach;", ""];
...
RadioTrigger_4 setTriggerStatements ["this", "[RadioTextMsg_4, RadioTextArt_4] call A_misc_fnc_SayDirectSpeach;", ""];
