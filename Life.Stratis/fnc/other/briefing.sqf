// A_other_fnc_briefing

#include "..\..\includes\macro.h"


if(player diarySubjectExists "Rules") exitWith {null};
...
<br/>
3: Hands Up<br/>
Raises hands to indicate surrender. Police can A_missions_fnc_search and handcuff a civilian while their hands are raised.
<br/>
...
<br/>
<br>
Ctrl + F (in a vehicle): Toggle A_other_fnc_siren On/Off (cops only)<br/>
...
Private Military Company is a place where Civilians can become Private Military Contractors.<br/>
	...
	-PMCs are allowed to carry PMC equipment, police may however can A_missions_fnc_search you for your licence.<br/>
...
Contracts Examples:<br/>
	...
	-A_missions_fnc_delivery/Logistics<br/>
...
player createDiaryRecord ["rules",
[
"A_missions_fnc_search Guidelines",
"
Random searches are allowed but must not be abused.<br/>
Examples of when you should A_missions_fnc_search:<br/>
