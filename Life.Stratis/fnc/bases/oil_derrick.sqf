...
private _ref = ["FlagSmall_F",_offset,_heading,true,true,true,"flag_",false,_id,true,_ref] call _cv;
...
[OIL_DERRICK_BARREL(_id,1)] call A_bases_fnc_oil_derrick_barrel_setup;
[OIL_DERRICK_BARREL(_id,2)] call A_bases_fnc_oil_derrick_barrel_setup;
[OIL_DERRICK_BARREL(_id,3)] call A_bases_fnc_oil_derrick_barrel_setup;