...
private["_action_id"];
_action_id = player addAction [_bunker_action_label, A_actions_fnc_action, [[_player, _bunker_door_data], "A_bunker_fnc_enter"],10,false,false,"", "true"];
A_bunker_var_actions = A_bunker_var_actions + [_action_id];
