...
([
	...
	["Clone object", {
		...
		[_nobject, [(_o select 0), (_o select 1), (_o select 2)], [(_h select 0), (_h select 1), (_h select 2)]] call A_camera_menu_fnc_camera_set_offset_heading;
	}],
	...
	["Set offset and heading from netId", {
		...
		_source = call A_camera_menu_fnc_camera_clipboard_objectFromNetId;
		_o = [_source, "offset", [0,0,0]] call A_object_fnc_getVariable;
		_h = [_source, "heading", [0,0,0]] call A_object_fnc_getVariable;
		[_object, [(_o select 0), (_o select 1), (_o select 2)], [(_h select 0), (_h select 1), (_h select 2)]] call A_camera_menu_fnc_camera_set_offset_heading;
	}],
	["Set heading from netId (clipboard)", {
		...
		[_object, _offset, _nheading] call A_camera_menu_fnc_camera_set_offset_heading;
	}],
	["Set offset from netId (Z axis)", {
		...
		[_object, OFFSET_AXIS_Z, OFFSET_OP_SET,(_offset select 2)] call A_camera_menu_fnc_camera_modify_offset;
	}],
	["Add to object heading (direction)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_DIRECTION, HEADING_OP_ADD, ([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Add to object heading (angle)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_ANGLE, HEADING_OP_ADD, ([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Add to object heading (pitch)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_PITCH, HEADING_OP_ADD, ([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Set object heading (direction)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_DIRECTION, HEADING_OP_SET, ([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Set object heading (angle)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_ANGLE, HEADING_OP_SET, ([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Set object heading (pitch)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, HEADING_AXIS_PITCH, HEADING_OP_SET,([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_heading;
	}],
	["Add to offset (Z axis)", {
		ARGV(0,_player);
		ARGV(1,_object);
		ARGV(2,_text);
		[_object, OFFSET_AXIS_Z, OFFSET_OP_ADD,([_text] call A_misc_fnc_parse_number)] call A_camera_menu_fnc_camera_modify_offset;
	}],
	["Toggle Attached", {
		ARGV(0,_player);
		ARGV(1,_object);
