...
A_plant_var_seed_data_id = 0;
A_plant_var_seed_data_name = 1;
A_plant_var_seed_data_model = 2;
A_plant_var_seed_data_life = 3;
A_plant_var_seed_data_scale = 4;
A_plant_var_seed_data_yield_item = 5;
A_plant_var_seed_data_field_markers = 6;
A_plant_var_seed_data_max = 7;
