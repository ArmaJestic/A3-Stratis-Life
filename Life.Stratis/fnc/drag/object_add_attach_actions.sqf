...
private["_actions"];
_actions = [];
_A_actions_fnc_action_id = _player addAction [format["Release %1", _label], "A_actions_fnc_action.sqf",
...
if (not((_type == "Fort")  || (isPlayer _object))) then {
	_A_actions_fnc_action_id = _player addAction [format["Put %1 in inventory", _label], "A_actions_fnc_action.sqf",
...
_A_actions_fnc_action_id = _player addAction [format["Put %1 in vehicle", _label], "A_actions_fnc_action.sqf", 
