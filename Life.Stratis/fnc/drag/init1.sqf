...
A_drag_var_attach_class = 0;
A_drag_var_attach_points = 1;
A_drag_var_attach_point_selection_name = 0;
A_drag_var_attach_point_selection_id = 1;
A_drag_var_attach_point_offset = 2;
A_drag_var_attach_point_heading = 3;
