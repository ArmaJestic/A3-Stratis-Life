...
_mobile_players_field ctrlAddEventHandler ["SetFocus", "(_this) call A_mobile_menu_fnc_combo_focus"];
_mobile_players_field ctrlAddEventHandler ["KillFocus", "(_this) call A_mobile_menu_fnc_combo_blur"];
...
buttonSetAction [mobile_text_button_idc, (
	...
	'(ctrlText mobile_menu_text_field_idc)] call A_interaction_fnc_mobile_send;' +
	'closedialog 0;')];
...
_mobile_menu_text_field ctrlSetText A_mobile_menu_var_default_text;
_mobile_menu_text_field ctrlCommit 0;


_mobile_menu_text_field ctrlAddEventHandler ["SetFocus", "(_this) call A_mobile_menu_fnc_text_focus"];
_mobile_menu_text_field ctrlAddEventHandler ["KillFocus", "(_this) call A_mobile_menu_fnc_text_blur"];
_mobile_menu_text_field ctrlAddEventHandler ["KeyDown", "(_this) call A_mobile_menu_fnc_text_keydown"];
