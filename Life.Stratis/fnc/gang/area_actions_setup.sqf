...
//Setup A_actions_fnc_actions for Gang Area 1
...
_ga1_actions = [_ga1_lsd_action, _ga1_cocaine_action, _ga1_capture_action, _ga1_neutralise_action, _ga1_shop_action];
 [gangarea1, "A_actions_fnc_actions", _ga1_A_actions_fnc_actions] call A_object_fnc_setVariable;

//Setup A_actions_fnc_actions for Gang Area 2
...
[gangarea2, "A_actions_fnc_actions", _ga2_A_actions_fnc_actions] call A_object_fnc_setVariable;

//Setup A_actions_fnc_actions for Gang Area 3
...
[gangarea3, "A_actions_fnc_actions", _ga3_A_actions_fnc_actions] call A_object_fnc_setVariable;
