...

{
	...
	_candidate_cuid = _candidate_cdata select INDEX_DATA_ELEC_CAND_DATA_ENTRY_UID;
	_candidate_vote_data = _candidate_cdata select INDEX_DATA_ELEC_CAND_DATA_ENTRY_VOTE_DATA;
	...
	_voter_found_index = -1;
	{
		...
		_vote_data_entry = _x;
		_vote_data_cuid = _vote_data_entry select INDEX_DATA_ELEC_CAND_ENTRY_VOTE_UID;
	...
	if (_voter_found_index >= 0) then {
		...
		_candidate_cdata set [INDEX_DATA_ELEC_CAND_DATA_ENTRY_VOTE_DATA, _candidate_vote_data];
	};
...
private["_vote"];
_vote = [];
_vote set [INDEX_DATA_ELEC_CAND_ENTRY_VOTE_UID, _voter_uid];
