...
A_inv_var_shop_list_item = 0;
A_inv_var_shop_list_stock = 1;
A_inv_var_shop_list_stock_max = 2;
A_inv_var_itemshops_object = 0;
A_inv_var_itemshops_name = 1;
A_inv_var_itemshops_crate = 2;
A_inv_var_itemshops_logic = 3;
A_inv_var_itemshops_buylist = 4;
A_inv_var_itemshops_selllist = 5;
A_inv_var_itemshops_license = 6;
...
_is = 
	[
		...
		["kanister", 10, 50],
		["A_item_fnc_handy", 10, 10],
		["A_item_fnc_lighter", -1, -1],
		["fishingpole", -1, -1],
		["knife", -1, -1],
		["woodaxe", -1, -1],
		["pickaxe", -1, -1]
...
_es = 
	[
		...
		["Binocular", 50, 50],
		["NVGoggles", 30, 30],
		["A_item_fnc_handy", 30, 30],
		["Medikit", 50, 30],
		["Firstaidkit", 50, 30],
		["A_item_fnc_lockpick", 30, 30],
		["Fuelline", -1, -1],
		["Chemlight_green", -1, -1],
		["Chemlight_red", -1, -1],
...
_copshop =
	[
		...
		["medikit", -1, -1],
		["Firstaidkit", -1, -1],
		["A_item_fnc_weaponbag", -1, -1],
		["A_item_fnc_itembag", -1, -1],
		["A_item_fnc_defuser", -1, -1],
		["A_item_fnc_vclammo", -1, -1],
		["A_item_fnc_lockpick", -1, -1],
		["A_item_fnc_nitro", -1, -1],
		["supgrade1", -1, -1],
		["supgrade2", -1, -1],
		["supgrade3", -1, -1],
		["supgrade4", -1, -1],
...
A_inv_var_vendor_object = 0;

A_inv_var_vendor_name = 1;
