...
if (A_interaction_var_interact_pump_barrel_hits <= 0) exitWith {
...
private["_amount"];
_amount = [([_barrel, "amount", 0] call A_object_fnc_getVariable)] call A_encoding_fnc_decode_number;
if (_amount  >= A_interaction_var_interact_crude_oil_barrel_hit_max) exitWith {
...
player groupChat format["You have poured %1 crude oil onto this barrel", A_interaction_var_interact_pump_barrel_hits];
[_barrel, (_amount + A_interaction_var_interact_pump_barrel_hits)] call A_object_fnc_item_update_amount;
