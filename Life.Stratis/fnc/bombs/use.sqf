...
_item   = _this select 1;
    ...
    if (_item == "zeitzuenderbombe") then {
        ...
        buttonSetAction [4, "[""plant"", ""zeitzuenderbombe"", sliderPosition 1] spawn A_bombs_fnc_bombs; closedialog 0;"];
    ...
    if (_item == "aktivierungsbombe") then {
        ["plant", "aktivierungsbombe"] spawn A_bombs_fnc_bombs;
    };
    ...
    if (_item == "geschwindigkeitsbombe") then {
        ...
        buttonSetAction [4, "[""plant"", ""geschwindigkeitsbombe"", sliderPosition 1, sliderPosition 8] spawn A_bombs_fnc_bombs; closedialog 0;"];
    ...
    if (_item == "fernzuenderbombe") then {
        ["plant", "fernzuenderbombe"] spawn A_bombs_fnc_bombs;
    };
