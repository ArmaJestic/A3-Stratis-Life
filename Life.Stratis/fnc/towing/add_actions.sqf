...
private["_action_id"];
_action_id = player addAction ["Attach towing line", A_actions_fnc_action, [[_player, _towing_vehicle, "towing"], "A_towing_fnc_line_attach"],10,false,true,"", format['not([%1] call A_towing_fnc_line_attached) && {([%2, "towing"] call A_towing_fnc_line_attached)}', _towing_vehicle, _player]];
