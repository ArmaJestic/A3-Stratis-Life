...
_vehicle addaction ["A_other_fnc_halo Jump",A_actions_fnc_noscript,'[_this select 0, _this select 1] call A_halo_fnc_jump;',1,false,true,"","[_target] call A_halo_fnc_jump_allowed"];
