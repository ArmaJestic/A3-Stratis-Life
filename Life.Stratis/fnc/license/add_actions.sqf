...

{
	...
	_clicense = _x;
	_clicense_id = _clicense select A_license_var_id;
	_clicense_name = _clicense select A_license_var_name;
	_clicense_price = _clicense select A_license_var_price;
	_clicense_vendors = _clicense select A_license_var_vendors;
