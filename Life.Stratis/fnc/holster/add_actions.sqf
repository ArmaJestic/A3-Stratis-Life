...
_holster_action = _player addAction ["Holster pistol", "noscript.sqf", format['[%1] call A_holster_fnc_hide_weapon;', _player], 1, false, true,"", '_in_hands = (call A_holster_fnc_pistol_in_hands); _in_inv = (call A_holster_fnc_pistol_in_inventory); _in_hands && not(_in_inv)'];
