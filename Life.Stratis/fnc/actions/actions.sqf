...
//===================================== Gas station Robbing===============================================
gsshop1 = fuelshop1 addaction ["Rob Gas Station 1", A_other_fnc_noscript, '[player, 1] call A_player_fnc_rob_station', 1, false, true, ""," !(isblu) && station1money >= 10000"];
//gsshop2 = fuelshop2 addaction ["Rob Gas Station 2", A_other_fnc_noscript, '[player, 2] call A_player_fnc_rob_station', 1, false, true, ""," !(isblu) && station2money >= 10000"];
//gsshop3 = fuelshop3 addaction ["Rob Gas Station 3", A_other_fnc_noscript, '[player, 3] call A_player_fnc_rob_station', 1, false, true, "",  "!(isblu) && station3money >= 10000"];
//gsshop4 = fuelshop4 addaction ["Rob Gas Station 4", A_other_fnc_noscript, '[player, 4] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station4money >= 10000"];
//gsshop5 = fuelshop5 addaction ["Rob Gas Station 5", A_other_fnc_noscript, '[player, 5] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station5money >= 10000"];
//gsshop6 = fuelshop6 addaction ["Rob Gas Station 6", A_other_fnc_noscript, '[player, 6] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station6money >= 10000"];
//gsshop7 = fuelshop7 addaction ["Rob Gas Station 7", A_other_fnc_noscript, '[player, 7] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station7money >= 10000"];
//gsshop8 = fuelshop8 addaction ["Rob Gas Station 8", A_other_fnc_noscript, '[player, 8] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station8money >= 10000"];
//gsshop9 = fuelshop9 addaction ["Rob Gas Station 9", A_other_fnc_noscript, '[player, 9] call A_player_fnc_rob_station', 1, false, true, "", "!(isblu) && station9money >= 10000"];

//========================   unflip vehicle     ================================
//action86 = _role addaction ["Unflip vehicle",A_other_fnc_noscript,"_this call A_interaction_fnc_vehicle_unflip;",1,false,true,"",'_vcl = (nearestobjects [getpos player, ["Air", "Ship", "LandVehicle"], 3] select 0); player distance _vcl < 5 and ([player, _vcl] call A_vehicle_fnc_owner) and !([player,_vcl] call A_mounted_fnc_player_inside)'];
...
//action91 = (vehicle player) addaction ["Jump Off",A_other_fnc_noscript,'moveOut player;',1,false,true,"",'_vcl = vehicle player;((_vcl iskindof "Motorcycle") or (_vcl iskindof "ATV_Base_EP1")) and !([player, _vcl] call A_vehicle_fnc_owner) and (locked _vcl) == 2 and (speed _vcl < 30)'];
//action112 = (vehicle player) addaction ["Break Out",A_other_fnc_noscript,'moveOut player;',1,false,true,"",'_vcl = vehicle player;(player != _vcl) and !([player, _vcl] call A_vehicle_fnc_owner) and (locked _vcl) == 2 and !(_vcl iskindof "Motorcycle") and !(_vcl iskindof "ATV_Base_EP1") and (speed _vcl < 30)'];
