...
_refuel_action = _vehicle addAction [format["Fill gas tank for $%1", _refuel_cost], A_actions_fnc_noscript, format["[%1] call A_actions_fnc_refuel_tank", _liter_price], 1];
